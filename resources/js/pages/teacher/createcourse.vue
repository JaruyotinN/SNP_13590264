        ...
        <router-link :to="{ name: 'calendar'}">ย้อนกลับ</router-link>
          ...
          <div class="card mt-5 mb-3">
                <div class="col-md-10 m-auto">
                        <h4 class="mb-5 mt-5 bold">สร้างหลักสูตรการฝึกงานของนักศึกษา</h4>   
                    <hr class="hr-orange">
                </div>
                <div class="col-md-10 mt-2 m-auto">
                   <div class="row" style="padding:20px;">
                         ...
                         <div class="col-md-4">
                            <p class="bold color-blue" >ชื่อหลักสูตร</p>
                            <div class="mt-2 mb-3">
                                  <input class="form-control" v-model="form.name" type="text" placeholder="ชื่อหลักสูตรของคุณ" required>
                              </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <p class="bold color-blue" >คำอธิบายหลักสูตร</p>
                            <div class="mt-2 mb-3">
...
export default {
 ...
 methods: {
    submitForm() {
        Swal.fire({
        title: 'ยืนยันหลักสูตร',
        text: "หากยืนยันหลักสูตรเรียบร้อยจะไม่สามารถแก้ไขในภายหลัง",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        cancelButtonText: 'ยกเลิก',
        confirmButtonText: 'ยืนยันหลักสูตร'
        }).then((result) => {
        if (result.value) {
         this.save();
            Swal.fire(
          'สร้างหลักสูตร',
          'ระบบสร้างหลักสูตรการฝึกงานของนักศึกษาเรียบร้อย',
          'success',
            )
        }
        })  
    ...
    async save() {
      ...
      const { data } = await this.form.post("/api/course");
